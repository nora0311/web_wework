...
class TestMaterial():
    ...
    def setup(self):
        ...
        self.material = Material(reuse=True)


    #  管理工具-素材库入口
    def test_pic_material(self):
        self.manage.material().pic_material("/Users/serenehoo/PycharmProjects/Selenium_pro/test_contact_selenium/testcase/rose.jpg")
